...
class Config:
    ...
    def __init__(self, config_file: str = None):
        ...
        self.fast_llm_model = os.getenv('FAST_LLM_MODEL', "gpt-4-turbo")
        ...
        self.max_search_results_per_query = int(os.getenv('MAX_SEARCH_RESULTS_PER_QUERY', 7))
        self.memory_backend = os.getenv('MEMORY_BACKEND', "local")
        self.total_words = int(os.getenv('TOTAL_WORDS', 3000))
